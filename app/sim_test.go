...
const (
	SimAppChainID = "consumerchain2-simapp"
)
...
func BenchmarkSimulation(b *testing.B) {
	...
	bApp := app.New(logger, db, nil, true, app.MakeEncodingConfig(), appOptions, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID))
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := app.New(log.NewNopLogger(), newDB, nil, true, app.MakeEncodingConfig(), appOptions, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID))
